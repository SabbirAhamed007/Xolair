...
public class LAP_Drug_EnrollmentTest {

	public static WebDriver driver;

	@Given("^I open xolair sites for LAP$")
	public void i_open_xolair_sites_for_LAP() throws Throwable {
	...
	@Given("^clicks on enrollment button$")
	public void clicks_on_enrollment_button() throws Throwable {

		driver.findElement(By.xpath(".//*[@id='container']/div[2]/div/a[1]")).click();
	}

	@Given("^select the LAP$")
	public void select_the_LAP() throws Throwable {
	...
	@Given("^select LAP not enrolled before$")
	public void select_LAP_not_enrolled_before() throws Throwable {
	...
	public void lap_apply_for_drug() throws Throwable {
	...
	@When("^Select eligibility questions$")
	public void select_eligibility_questions() throws Throwable {
	...
	@When("^enter patient info for drug$")
	public void enter_patient_info_for_drug() throws Throwable {
	...
	@When("^enter the insurance information$")
	public void enter_the_insurance_information() throws Throwable {
	...
	public void i_fill_in_prescriber_info() throws Throwable {
	...
	@Then("^I fill the site of care information$")
	public void i_fill_the_site_of_care_information() throws Throwable {
	...
	@Then("^I confirm info$")
	public void i_confirm_info() throws Throwable {

		driver.findElement(By.id("allcorrect")).click();

	}

	@Then("^Clicks on confirm button$")
	...
	@Then("^close Xolair browser$")
	public void close_Xolair_browser() throws Throwable {
