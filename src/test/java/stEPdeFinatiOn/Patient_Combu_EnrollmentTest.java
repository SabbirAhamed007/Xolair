...
public class Patient_Combu_EnrollmentTest {

	public static WebDriver driver;

	@Given("^I open the xolair sites$")
	public void i_open_the_xolair_sites() throws Throwable {
	...
	@Given("^click the enrollment button$")
	public void click_the_enrollment_button() throws Throwable {

		driver.findElement(By.xpath(".//*[@id='container']/div[2]/div/a[1]")).click();

	}

	@Given("^select the patients$")
	public void select_the_patients() throws Throwable {
	...
	@Given("^select the patients not enrolled before$")
	public void select_the_patients_not_enrolled_before() throws Throwable {
	...
	public void i_apply_for_combu() throws Throwable {
	...
	@When("^Select the eligibilities question$")
	public void select_the_eligibilities_question() throws Throwable {
	...
	@When("^enter the patients info$")
	public void enter_the_patients_info() throws Throwable {
	...
	@When("^enter the insurances info$")
	public void enter_the_insurances_info() throws Throwable {
	...
	public void i_fill_in_the_prescribers_information() throws Throwable {
	...
	@Then("^I fill the site of cares information$")
	public void i_fill_the_site_of_cares_information() throws Throwable {
	...
	@Then("^I confirm information$")
	public void i_confirm_information() throws Throwable {

		driver.findElement(By.id("allcorrect")).click();
	}

	@Then("^Clicks confirm button$")
	public void clicks_confirm_button() throws Throwable {
